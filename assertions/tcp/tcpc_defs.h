...
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_ESTABLISHED 2
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_CLOSED 3
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCP_INIT 4
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_FIN_WAIT_1 5
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_FIN_WAIT_2 6
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_LISTEN 7
#define TCPC_EVENT_FUNC_PROLOGUE_TCP_FREE 8
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_SYN_SENT 9
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_CLOSE_WAIT 10
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_SYN_RECEIVED 11
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_TIME_WAIT 12
